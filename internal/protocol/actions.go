...
func AllActions() []ActionSpec {
	return []ActionSpec{
		...
		},
		{
			...
			Outputs:     []string{"aligned", "warned (body-overlap)", "unresolved (boxed-in/pad/off-board)", "labelCollisions (placed on the least-bad slot but still overlapping another label)", "skipped", "details (clean judged on violation counts; labelOverlap)", "unresolvedDetails", "labelCollisionDetails ({designator, with[]})", "skippedDetails"},
